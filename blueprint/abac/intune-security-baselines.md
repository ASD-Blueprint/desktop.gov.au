...
* Platform: `Windows 10 and later`
* Security Baselines: `Windows 10 Security Baseline`
...
* Configuration settings
  ...
  * Connectivity
    ...
    * Hardened UNC path list: ``requireMutualAuthentication,requireIntegrity \\*\SYSVOL`, `requireMutualAuthentication,requireIntegrity \\*\NETLOGON` zzz
