...
To assist organisations in determining the maturity of their implementation of the Essential Eight, the Essential Eight Maturity Model has been developed. The model defines three (3) maturity levels for each mitigation strategy. Details of the ACSC maturity model have been included in the Toolkit to assist Entities implementing the Blueprint with any internal verification they may choose to perform. 
