...
![Figure 6 Alert Resolution Email](../img/security/alert-resolution-email.png#center)
...
![Figure 8 New Support Request](../img/security/new-support-request.png#center)
