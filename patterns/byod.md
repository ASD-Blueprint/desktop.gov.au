...
--- | --- | ---| ---
 Mobile device access (Option 1) | Provides ad-hoc access on the road and in the office to email, Teams and SharePoint from personally owned mobile devices such as iOS and Android devices. <br />Use-case provides some offline access if connectivity is limited.<br /><br />Not suitable for sensitive data. | Easiest             | Inability yo enforcing device security controls<br /><br />Limited ability to check compliance for zero trust<br /><br />Lost phone, potential inability to remote data wipe as phone is not fully managed 
